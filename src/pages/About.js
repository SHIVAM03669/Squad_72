export function About() {
  const teamMembers = [
    ...
    {
      name: 'Heramb Inamke',
      role: 'Pixel Perfectionist & React Dev.',
      photo: '/hem.jpg',
      description: 'Tech geek who loves crafting web services. Provided creative input and contributed to the website codebase.'
    }
  ];
